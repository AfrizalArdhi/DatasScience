...
metrics <- data.frame(
  ...
  F1_Score = 2 * (confusion_mat$byClass[, "Pos Pred Value"] * confusion_mat$byClass[, "Sensitivity"]) /
    (confusion_mat$byClass[, "Pos Pred Value"] + confusion_mat$byClass[, "Sensitivity"])
)
# Menampilkan hasil
print(metrics)
```
...
ui = page_fluid(
  ...
  layout_columns(
    ...
    selectInput("ncp", "How many meals do you have daily: ", choices = list("Choose" = "", "1 Meal" = 1, "2 Meals" = 2, "3 Meals" = 3), selected = ""),
